...
# ==================== 扫描模式过滤器 ====================
card_price              = 1.5       # 卡牌价格，单位：元，可为小数，若有卡则价格折扣判定减去该值，仅扫描折扣模式
...
max_discount_display    = 1.05      # py榜单展示的最高折扣，一般应大于等于实际折扣，仅检测用，实际购买以实际折扣为准，仅扫描折扣模式
max_discount_real       = 0.031     # 接受的最高折扣，实际折扣比该数字高则不计入，0.05指 -95% off，仅扫描模式
